...
<link href="D:\Users\angbhatt\Downloads\mongodbdemonew\src\main\resources\static\css\style.css" rel="stylesheet" type="text/css" media="all" /><!-- style.css -->
			...
			<div class="wthreenavigation">
				...
				<nav class="menu">
					<div class="icon-list">
						...
						<a href="books.html"><i class="fa fa-book"></i><span>Books</span></a>
						</div>
				</nav>
			...
			<div class="w3ls-header-right">
				<ul>
					<li class="dropdown head-dpdn">
						<a href="signindemo" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> Sign In</a>
					</li>
	...
	<div class="agile-its-selectregion">
		...
		<div class="container">
			<div class="agile-its-header">
				<div class="logo">
					<h1><a href="index.html"><span>OLX</span></a></h1>
				</div>
			...
			<ul class="rslides" id="slider">
				<li>
					<div class="w3ls-slide-text">
						...
						<!--<a href="categories.html" class="w3layouts-explore-all"></a>-->
					</div>
				</li>
			...
			<div class="container">
				...
				<div class="col-md-3 wthree-footer-grid">
							...
							<ul>
								...
								<li><a href="contactus.html"><i class="fa fa-long-arrow-right"></i>Contact Us </a></li>
								<li><a href="usefullinks.html"><i class="fa fa-long-arrow-right"></i>Useful Links</a></li>
								<li><a href="termsconditions.html"><i class="fa fa-long-arrow-right"></i>Terms and conditions</a></li>
